---
title: "Interact with Australia's 2020 Coronavirus Data"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Interact with Australia's 2020 Coronavirus Data}
...
Welcome to the 'ozcovid' package! The purpose of this package is to allow you - the user - to interact with Australia's 2020 coronavirus data. The package aims to do this in two main ways - a shiny application called 'Coronavirus in Australia' and a dataset called 'oz_covid_data'.
...
3. Deaths In Victoria: an interative graph of Victoria's coronavirus-related deaths where the user is able to click on a data point of their choice which in turn generates a sentence desrcibing the date and the deaths that occured on that date in Victoria.

The application can be executed as such:
...
The 'oz_covid_data' data table summarises Australia's 2020 coronavirus data. 

The dataset is a processed version of Rami Krispin's coronavirus' dataset from the ['coronavirus' package](https://github.com/RamiKrispin/coronavirus.). If the dataset looks familar to you, it is because it is inspired by the 'Coronavirus Summary Table' from the 'Coronavirus in Australia' Shiny application.
